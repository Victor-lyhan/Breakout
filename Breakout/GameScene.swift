...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func resetGame() {
        //this stuff happensbefore each game starts
        makeBall()
        makePaddle()
        makeBricks()
        updateLabels()
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        // ask each bricks, "Is it you"
        for brick in bricks{
            if contact.bodyA.node == brick ||
                contact.bodyB.node == brick {
                score += 1
                // increase ball velocity in 2%
    ...
    func makeBall(){
        ...
        //ignores all forces an dimpulses
        ...
        //bouces fully off of other objects
    ...
    func makeBricks() {
        ...
        //fogure the number and spacing of each row of bricks
